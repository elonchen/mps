...
function msetcookie($var,$val,$life=0){
	...
	$life = $life ? $life : 3600;
	$life = $timestamp+$life;
	//$res=setcookie($cookie_pre.$var,$val,$life,$cookie_path,$cookiedomain);	
	setcookie($cookie_pre.$var,$val,$life,$cookie_path);
}
...
{
	$msgs="未知错误，可能与你提交的参数有关<br /><br />获取更多帮助请前往<a href=http://www.it-works.com.cn target=_blank>官方网站</a>";
