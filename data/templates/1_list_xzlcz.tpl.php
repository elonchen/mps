...
<font style="font-size:12px"><?=$mymps['areaname']?> / <? echo get_format_time($mymps['begintime']); ?></font>			</span>
<span class="lacreage"><?=$mymps['acreage']?></span>
<span class="lprice"><?=$mymps['min_rent']?></span>		</div>
<?php }} ?>
</ul>
<!--栏目列表页尾部广告开始-->
