...
<div><a href="#" class="currentr"><span></span><?=$cat['catname']?></a></div>
</div>
...
<span class="lprice"><span class="rprice"><? if($mymps['mini_rent'] == '0元') { ?>面议<?php } else { ?><?=$mymps['mini_rent']?><?php } ?></span><br /><?=$mymps['room_type']?></span>
</div>
<?php }} ?>
</ul>
...
<div class="clear"></div>
<div class="totalpost"><a href="<?=$mymps_global['SiteUrl']?>/<?=$mymps_global['cfg_postfile']?>?catid=<?=$cat['catid']?>&cityid=<?=$city['cityid']?>" target="_blank">马上发布<?=$city['cityname']?><?=$cat['catname']?>信息&raquo;</a></div>
</div>
</div>
    <div class="clear"></div>
<div class="colorfoot">
