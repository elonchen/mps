...
<div><a href="#" class="currentr"><span></span><?=$city['cityname']?><?=$cat['catname']?>简历</a></div>
</div>
...
<span class="ltitle">
<a title="<?=$mymps['title']?>" href="<?=$mymps['uri']?>" target="_blank"  style="<? if($mymps['ifred'] == 1) { ?>color:red;<?php } ?> <? if($mymps['ifbold'] == 1) { ?>font-weight:bold;<?php } ?>"><? echo cutstr($mymps['title'],20); ?></a><? if($mymps['img_count']) { ?><span class="img_count"><?=$mymps['img_count']?>图</span><?php } if($mymps['certify'] == 1) { ?><span class="certify">认证</span><?php } ?>
</span>
...
<span class="lage"><?=$mymps['age']?>&nbsp;</span>
<span class="lxueli"><?=$mymps['education']?>&nbsp;</span>
<span class="lexp"><?=$mymps['work_life']?>&nbsp;</span>
</div>
<?php }} ?>
</ul>
