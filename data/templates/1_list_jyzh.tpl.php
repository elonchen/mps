...
<a href="<?=$mymps['uri']?>" target="_blank"  style="<? if($mymps['ifred'] == 1) { ?>color:red;<?php } ?> <? if($mymps['ifbold'] == 1) { ?>font-weight:bold;<?php } ?>"><?=$mymps['title']?></a><? if($mymps['img_count']) { ?><span class="img_count"><?=$mymps['img_count']?>图</span><?php } if($mymps['info_level'] == 2) { ?><span class="tuijian">推荐</span><?php } if($mymps['certify'] == 1) { ?><span class="certify">认证</span><?php } ?><font class="area">(<?=$mymps['areaname']?>)</font> <br />
...
<div class="clear"></div>
<div class="totalpost"><a href="<?=$mymps_global['SiteUrl']?>/<?=$mymps_global['cfg_postfile']?>?catid=<?=$cat['catid']?>" target="_blank">马上发布一条<?=$city['cityname']?><?=$cat['catname']?>信息&raquo;</a></div>
</div>
