...
<span class='pull-rights'><span class="highlights"><? if($mymps['price'] == '0元') { ?>面议<?php } else { ?><?=$mymps['price']?><?php } ?></span></span>
...
<div class='typo-smalls'><?=$mymps['areaname']?> / <? echo get_format_time($mymps['begintime']); ?></span> <span class='highlight'><?=$mymps['from']?></span></div>
</div>
</div>
<?php }} ?>
<!--栏目列表页尾部广告开始-->
