...
<span class="lprice"><span class="rprice"><? if($mymps['prices'] == '0万元') { ?>面议<?php } else { ?><?=$mymps['prices']?><?php } ?></span><br /><?=$mymps['acreage']?></span>
</div>
<?php }} ?>
</ul>
