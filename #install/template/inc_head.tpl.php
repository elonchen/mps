  ...
  <div class="wrapB">
	<div class="wrapC">
	  <div id="header">
		...
		<div class="right"> <a href="https://www.it-works.com.cn" target="_blank" class="linkA">官方网站</a> | <a href="https://www.it-works.com.cn" target="_blank" class="linkA">使用手册</a></div>
	  </div>
      <div id="main">
